...
//		}
	...
	protected static <T> void setProperties(Properties properties, T clazz) throws IllegalArgumentException, IllegalAccessException {
	...
	protected static <T> void getInstance(String propertiesFileName,
			T clazz) throws ConverterException{
		...
		try {
			...
			properties2.load(new FileInputStream(propertiesBase));
			
		} catch (FileNotFoundException e) {
			
			//throw new InputSettingsException(true, "Can't read properties file.");
		...
		try {
			...
			//throw new InputSettingsException(true, "Can't read property from file.");
